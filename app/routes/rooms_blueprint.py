...
from app.controllers.room_controller import post_room, get_by_id_room, patch_room, delete_room, get_room, get_rooms_available
...
bp_rooms.get("/available")(get_rooms_available)
